    ...
    public class WaveManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (AudioManager.Instance != null) {
                AudioManager.Instance.StartPlayingBattleMusic();
            }
        ...
        private void CheckForWaveTimes()
        {
            ...
            {
                Debug.Log("Changing wave time"+waveNumber+"with index" + waveTimesIndex);
                waveTimesIndex++;
        ...
        private void GameWined()
        {
            ...
            AudioManager.Instance.StartPlayingMenuMusic();
