...
public class CameraMovement : MonoBehaviour
{
    ...
    private void ProcessAngle(float angle)
    {
        if(angle < 30)
        {
            ...
            average *= CameraMovementSpeed * Time.deltaTime * (cam.orthographicSize/maxZoomSize);
    ...
    {
        float newSize = Math.Clamp(cam.orthographicSize + offset, 5f, 40);
